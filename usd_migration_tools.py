...
class USDmigrationUtils:
    ...
    def createMainTemplate(self, dir_path):
        ...
        materiallib_lop.moveToGoodPosition()
        ...
        for i, material in enumerate(materials):
            ...
            #Layout VOP nodes
            usd_uv_texture.moveToGoodPosition()
            mtlsurface.moveToGoodPosition()
            output_ref.moveToGoodPosition()

        #usd rop export
        usd_rop_export = materiallib_lop.createOutputNode("usd_rop")
        usd_rop_export.parm("lopoutput").set(dir_path + "/usd_export/" + self.asset_name + ".usd") #change suffix to .usdz for full houdini lic
